...
export default function ProblemsPage() {
  ...
  async function getProblems(type) {
    try {
      ...
      const problemsData = await GET({
        url: `/api/v1/problem?type=${type}`,
        lang: language,
      });
  ...
  const filteredProblems = useMemo(() => {
    return problems.filter((problem) => {
      ...
      const matchesType =
        selectedType === "all" || problem.problemType?.id === selectedType;
      ...
      <Container maxWidth="lg" className="py-5">
        ...
        <div className={styles.hero}>
          ...
          <p className={styles.subtitle}>
            Solve step-by-step math problems with bilingual explanations. Choose
          ...
          <>
            ...
            <div className={styles.statsBar}>
              <div className={styles.statsText}>
                ...
                of <span className={styles.statsCount}>{problems.length}</span>{" "}
                problems
              </div>
            </div>
